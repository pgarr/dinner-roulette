...
class TestServices(TestCase):
    ...
    def test_clone_recipe_to_waiting_full(self):
        ...
        self.assertIsInstance(waiting_model.ingredients[0], waiting_model.ingredient_class)
        ...
        self.assertIsInstance(waiting_model.ingredients[1], waiting_model.ingredient_class)
    ...
    def test_push_updates_to_recipe_new_recipe_full_data(self):
        ...
        self.assertIsInstance(recipe_model.ingredients[0], recipe_model.ingredient_class)
        ...
        self.assertIsInstance(recipe_model.ingredients[1], recipe_model.ingredient_class)
