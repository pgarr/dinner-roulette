...
class TestServices(TestCase):
    ...
    def test_clone_recipe_to_waiting_empty(self):
        ...
        self.assertIsInstance(waiting_model, WaitingRecipe)
    ...
    def test_clone_recipe_to_waiting_full(self):
        ...
        self.assertIsInstance(waiting_model.ingredients[0], WaitingRecipeIngredient)
        ...
        self.assertIsInstance(waiting_model.ingredients[1], WaitingRecipeIngredient)
    ...
    def test_push_updates_to_recipe_new_recipe_full_data(self):
        ...
        self.assertIsInstance(recipe_model, Recipe)
        ...
        self.assertIsInstance(recipe_model.ingredients[0], RecipeIngredient)
        ...
        self.assertIsInstance(recipe_model.ingredients[1], RecipeIngredient)
